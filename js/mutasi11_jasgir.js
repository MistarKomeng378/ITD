...
{    
    ...
    columns_mutasi11_client = [
        ...
        ,{id:"client_name", name:"Client Name", field:"client_name",width:320}
        ,{id:"client_acc_no", name:"Account No", field:"client_acc_no",width:140}
        ,{id:"client_cif", name:"Client CIF", field:"client_cif",width:85}
        ,{id:"client_cbest", name:"Client CBEST", field:"client_cbest",width:140}
...
function create_mutasi11_client_event()
{
    ...
    $("#hbtn_mutasi11_client_edit").click(function(){
        ...
        if(selected_row_mutasi11_client)
            open_dlg_mutasi11_client(data_mutasi11_client[selected_row_mutasi11_client.row].client_id);
        else
