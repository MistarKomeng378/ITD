    ...
    $("#dialogBox_mutasi11_4").dialog({ 
        ...
        ,buttons: {
             "Cetak Jasa Giro All": function(){
                 ...
                 loadPrintDocument(uri+'index.php/mutasi_dlg/print_41/'+$("#i_mutasi11_dlg4_pdt").val()+'_'+$("#i_mutasi11_dlg4_proc").val());    
             }, 
             "Cetak JaGir Reksadana": function(){
                   //window.open(uri+'index.php/mutasi_dlg/print_4/'+$("#i_mutasi11_dlg4_c_dt1").val()+'_'+$("#i_mutasi11_dlg4_pdt").val()+'_'+$("#i_mutasi11_dlg4_proc").val());
                 loadPrintDocument(uri+'index.php/mutasi_dlg/print_41/'+$("#i_mutasi11_dlg4_pdt").val()+'_'+$("#i_mutasi11_dlg4_proc").val()+'/1');    
             }, 
             "Cetak JaGir Unit Link": function(){
                   //window.open(uri+'index.php/mutasi_dlg/print_4/'+$("#i_mutasi11_dlg4_c_dt1").val()+'_'+$("#i_mutasi11_dlg4_pdt").val()+'_'+$("#i_mutasi11_dlg4_proc").val());
                 loadPrintDocument(uri+'index.php/mutasi_dlg/print_41/'+$("#i_mutasi11_dlg4_pdt").val()+'_'+$("#i_mutasi11_dlg4_proc").val()+'/2');    
             }, 
             "Cetak JaGir Diskre": function(){
                   //window.open(uri+'index.php/mutasi_dlg/print_4/'+$("#i_mutasi11_dlg4_c_dt1").val()+'_'+$("#i_mutasi11_dlg4_pdt").val()+'_'+$("#i_mutasi11_dlg4_proc").val());
                 loadPrintDocument(uri+'index.php/mutasi_dlg/print_41/'+$("#i_mutasi11_dlg4_pdt").val()+'_'+$("#i_mutasi11_dlg4_proc").val()+'/3');    
             }, 
             "Simpan Jasa Giro":function(){
                  window.open(uri+'index.php/mutasi_dlg/save_41/'+$("#i_mutasi11_dlg4_pdt").val()+'_'+$("#i_mutasi11_dlg4_proc").val());
             },
...
{           
    ...
    get_giro_mutasi11_dlg4(saiki,$("#i_mutasi11_dlg4_proc").val());
...
function get_giro_mutasi11_dlg4(pv_dt,p_uid)
{                                                                   
    state_progress(1); 
    var obj_post1 = $.post(uri+"/index.php/mutasi_dlg/get_giro_val_asof_by_user1", {v_dt:pv_dt,u_id:p_uid},function(data) {      
...
{                                 
    ...
    $("#b_mutasi11_dlg4_getdata").click(function(){  
        get_giro_mutasi11_dlg4($("#i_mutasi11_dlg4_pdt").val(),$("#i_mutasi11_dlg4_proc").val());
    });
}
