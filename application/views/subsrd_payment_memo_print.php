...
<head>
    <meta charset="utf-8">
    <title>Instruksi Transfer Dana</title>  
    <style type="text/css">
body {
...
<div style="color: #F0F0F0;" align="center">. <br /><br /><br /><br /><br /><br /><br /></div>
<!--
...
<table width="100%" border="0" cellspacing="2" cellpadding="3" bgcolor="#000000">
<tr bgcolor="#ffffff">
    <td align="center" ><b>NAMA KLIEN</b></td>
    <td align="center" width="30%"><b>NOMINAL</b></td>
    <td align="center" width="10%"><b>BUNGA</b></td>
</tr>
<tr bgcolor="#ffffff">
    <td align="center">
...
<tr>
    ...
    <td width="2%">:</td>
    <td><?php echo $r_sdata["due_desc"];?></td>
</tr>  
<tr>
...
<div style="text-align: right;"><?php echo $r_sdata["trx_type"] . $r_sdata["trx_deposit_type"] . $r_sdata["trx_validation_key"];?></div>
<br /> <br />
<table width="100%">
    <tr>                             
