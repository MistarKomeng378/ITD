<div style="border: 1px solid #7C3C10;display: none; margin-bottom: 5px; padding: 3px; font-weight: bold;" align="center" id="s_trx_bilyet_no">
<span id="i_trx_bilyet_no"></span> <br />
Bilyet Tetap : <input type="checkbox" id="i_trx_move_bilyet" value="1" /> YA
</div>
<div style="border: 1px solid #7C3C10;">
<input type="hidden" id="i_trx_id" name="i_trx_id" />
<input type="hidden" id="i_trx_id_master" name="i_trx_id_master" />
<input type="hidden" id="i_trx_id_upper" name="i_trx_id_upper" />
...
<tr bgcolor="#ffffff">
    ...
    <td align="center" width="15%">NISBAH / BUNGA</td>
...
<tr bgcolor="#ffffff">
    ...
    <input type="text" name="i_trx_nominal" id="i_trx_nominal" style="width: 130px;text-align: right;" /> 
    </td>
    ...
    <td align="center" valign="bottom" id="td_trx_rate_break1" style="display: none;"><div style="width:70px;"><input type="text" name="i_trx_rate_break" id="i_trx_rate_break" style="width: 35px;text-align: right;;" /> %  pa</div></td>
</tr>
</table>    
</div>
