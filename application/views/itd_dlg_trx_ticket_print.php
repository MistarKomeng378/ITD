...
<tr bgcolor="#ffffff" align="center">
    ...
    <td width="25%" colspan="5" valign="top"><b>Tax</b><br /><?php echo number_format($c_tax,2,'.',',');?> %<br /><?php echo number_format($c_taxamount,2,'.',',');?></td>
    ...
    <td width="30%" colspan="6" valign="top"><b>Net Settlement Received</b><br /><?php echo number_format($c_net,2,'.',',');?></td>
    <td width="5%" colspan="1" valign="top">ID<br /><?php /*echo $c_id;*/?></td>
</tr>                         
<tr bgcolor="#ffffff">
    <td width="5%" colspan="20">
        <table width="100%" cellpadding="0" cellspacing="0">
            ...
            <td valign="top">
            <div style="height: 120px; overflow:inherit;">
            <?php 
            echo nl2br($c_note);
            if($c_type==4)
            {
                $rate1= $c_amount * $c_rate1 / 100 * $c_term /  $c_year;
                echo "<br />Intruction Interest Rate: {$c_rate1}% - Rp." . number_format($rate1,2,'.',',') ;
                echo "<br />Break Interest Rate: {$c_rate}% - Rp." . number_format($c_intamount,2,'.',',') ;
                echo "<br />Difference Interest Recieve: Rp." . number_format($rate1 - $c_intamount,2,'.',',') ;
            }
            ?>
            </div></td>
        </table>
