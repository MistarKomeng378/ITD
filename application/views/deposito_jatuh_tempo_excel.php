    ...
    <table>
        ...
        ?>
            ...
            <tr>
                ...
                <td class="str"><?php echo $value['trx_valuta_date_s']; ?></td>
                <td class="str"><?php echo $value['trx_due_date_s']; ?></td>
                ...
                <td class="str"><?php echo $value['trx_rate']; ?> %</td>
                <td><?php echo $value['payment_desc']; ?></td>
                <td><?php echo $value['trx_create_by']; ?></td>
                <td class="str"><?php echo $value['trx_create_dt_s']; ?></td>
            </tr>
