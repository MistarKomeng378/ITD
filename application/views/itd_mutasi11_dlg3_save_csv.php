...
if($lvl>-5) { 
    ...
    {     
        ...
        { 
            ...
            { 
                if( ($incl_sign!='a' && $incl_sign!='-') || ($incl_sign=='a' && in_array($field_no,$incl)) || ($incl_sign=='-' && !in_array($field_no,$incl)))
                {
                    ...
                    echo  'CREDIT,A,' . $items['acc_no'] .  ',' . number_format($items['giro_interest_net'],2,'.','') . ',JASA GIRO,3342' . "\r\n"  ;
                    $irow++;
        ...
        echo 'CREDIT,G,079512220000000,' . number_format($total_tax,2,'.','') . ',JASA GIRO,3342' . "\r\n" ;
        echo 'DEBIT,G,079328065010100,' . number_format($total_giro,2,'.','') . ',JASA GIRO,3342' . "\r\n" ;
